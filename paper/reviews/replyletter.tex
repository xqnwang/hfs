...
scaled forecast variance and strong correlations with other series are
more likely to be excluded. For the empirical applications, we did not
...
matrix for reconciliation, thereby improving computational efficiency.
