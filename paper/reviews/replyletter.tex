...
forecast variance
\todo{"high forecast variance"? The top level series might have high forecast variance due to large scale, but that doesn't mean it should be excluded}
...
response.) \todo{I have added few more lines to the third paragraph}
...
complex hierarchies can be time-consuming
\todo{I don't think we address this in our work though it is an issue in hts}.
