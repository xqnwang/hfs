...
Forecast reconciliation methods could consider the loss function [@Ben_Taieb2019-be] given by
$$
\begin{aligned}
...
\newpage
\appendix
\pagenumbering{arabic} % reset `page` counter to 1
