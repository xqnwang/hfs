...
#| warning: false
#| results: asis
#| tbl-cap: Number of time series selected using different proposed methods and the optimal parameter values identified in the labour application, condering a single test set (from August 2022 to July 2023).
