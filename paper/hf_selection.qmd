...
#| label: tbl-time
#| results: asis
#| tbl-cap: Computational time (in seconds) for a single hierarchy across the four experiments, considering all candidate hyperparameters.
