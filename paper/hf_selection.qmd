...
The code written in R for reproducing the results is available at LINK.
...
A remarkable feature of the proposed methods is their ability to reduce the disparities arising from using different estimates of $\boldsymbol{W}$, thereby mitigating the challenges associated with estimator selection, a prominent issue within the field of forecast reconciliation research.
