...
#| results: asis
#| tbl-cap: Proportion of time series being selected using proposed reconciliation methods for simulation Setup 1. RMSSE values for each series are in parentheses. The last column displays a stacked barplot of the total selected series from 500 hierarchies, with darker sub-bars indicating higher counts.
...
It preserves the unbiasedness of forecasts, is able to restore the hierarchy.) Discuss the practical (OR) significance of the current paper. Unused series.
...
#| results: asis
#| tbl-pos: "!h"
#| tbl-cap: Proportion of time series being selected using proposed reconciliation methods for simulation Setup 1, with model misspecification in series AA. RMSSE values for each series are in parentheses. The last column displays a stacked barplot of the total selected series from 500 hierarchies, with darker sub-bars indicating higher counts.
...
#| results: asis
#| tbl-pos: "!h"
#| tbl-cap: Proportion of time series selected using proposed reconciliation methods for simulation Setup 2, with error correlation being -0.4. RMSSE values for each series are in parentheses. The last column displays a stacked barplot of the total selected series from 500 hierarchies, with darker sub-bars indicating higher counts.
...
#| results: asis
#| tbl-pos: "!h"
#| tbl-cap: Proportion of time series selected using proposed reconciliation methods for simulation Setup 2, with error correlation being 0. RMSSE values for each series are in parentheses. The last column displays a stacked barplot of the total selected series from 500 hierarchies, with darker sub-bars indicating higher counts.
