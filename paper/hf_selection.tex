...
reconciliation with series selection under the unbiasedness assumption,
resulting in three optimization problems: (i) group best-subset
selection with ridge regularization, (ii) parsimonious method with
\(L_0\) regularization, and (iii) group lasso method.
...
Although Subset, Parsimonious, and Lasso methods introduced in
...
and ERM methods from simulation studies and empirical results due to
