...
hyperparameters and rolling test sets. In terms of computational
resources we used 20 CPUs and 3 GB of memory per CPU in a
high-performance computing system. Given these computational demands, we
recommend applying the proposed methods primarily to hierarchies of
small to moderate size. While there are ongoing efforts to develop
MIP-based approaches for solving \(L_0\)-regularized regression in
high-dimensional settings \citep{Mazumder2022-hx}, extending these
approaches to accommodate additional constraints remains a challenge,
