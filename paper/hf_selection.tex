...
hierarchical or grouped structure, it can lead to worse forecasts for
certain series, with the greatest gains typically seen in series that
originally have poorly performing base forecasts. In practical
applications, some series in a structure often produce poor base
...
Forecast reconciliation methods could consider the loss function
...
\citet{Zhang2023-op} in four main ways. First, our proposed methods keep
