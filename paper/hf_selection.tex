...
While forecast reconciliation can enhance overall accuracy in a
hierarchical or grouped structure, the most substantial improvements
generally occur in series with initially poor-performing base forecasts.
Forecasts of certain series may get worse after reconciliation. In
practical applications, some series in a structure often produce poor
base forecasts due to model misspecification or low forecastability. To
mitigate their negative impact, we propose two categories of forecast
reconciliation methods that incorporate automatic time series selection
...
forecasts, while adjusting the weights assigned to the remaining series
...
estimators of the base forecast error covariance matrix, alleviating
...
force and domestic tourism data demonstrate the potential of the
...
\todo{Is it conditional MSE or unconditional MSE? In the 2019 paper, we used conditional expectation but later I thought it should be unconditional MSE. XQ --- I think it follows the idea in the 2019 paper, which is based on conditional MSE. Why do you think it should be unconditional MSE? If that is the case, should we remove $\bm{I}_T$ from the equation?}
...
\todo[inline]{I think it should be conditional, because otherwise you end up with $E[\bm{y}_{T+h}]$ on the RHS which may not even be defined.

Is it correct to say that this is "in general". It is possibly to use a loss function that is not L2.}
...
\midrule
OLS-subset & 0.55 & 0.04 & 0.41 & 0.74 & 0.78 & 0.79 & 0.83 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_OLS-subset.png}\\
OLS-parsim & 0.61 & 0.04 & 0.52 & 0.75 & 0.69 & 0.69 & 0.83 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_OLS-parsim.png}\\
OLS-lasso & 0.04 & 0.35 & 0.02 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.45 & 0.06 & 0.36 & 0.81 & 0.84 & 0.81 & 0.87 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSs-subset.png}\\
WLSs-parsim & 0.61 & 0.06 & 0.48 & 0.75 & 0.71 & 0.73 & 0.84 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSs-parsim.png}\\
WLSs-lasso & 0.02 & 0.33 & 0.02 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.54 & 0.29 & 0.46 & 0.91 & 0.94 & 0.86 & 0.89 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSv-subset.png}\\
WLSv-parsim & 0.59 & 0.32 & 0.53 & 0.82 & 0.86 & 0.77 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSv-parsim.png}\\
WLSv-lasso & 0.27 & 0.42 & 0.26 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 0.69 & 0.64 & 0.66 & 0.95 & 0.96 & 0.90 & 0.90 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinT-parsim.png}\\
MinT-lasso & 0.82 & 0.74 & 0.83 & 1.00 & 0.99 & 0.97 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 0.62 & 0.63 & 0.58 & 0.95 & 0.96 & 0.90 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinTs-parsim.png}\\
MinTs-lasso & 0.68 & 0.75 & 0.68 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.78 & 0.95 & 0.68 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s2_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.32 & 0.34 & 0.95 & 0.98 & 1 & 0.74 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_OLS-subset.png}\\
OLS-parsim & 0.58 & 0.52 & 0.93 & 0.97 & 1 & 0.61 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_OLS-parsim.png}\\
OLS-lasso & 0.61 & 0.34 & 0.38 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.27 & 0.40 & 0.98 & 1.00 & 1 & 0.73 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSs-subset.png}\\
WLSs-parsim & 0.49 & 0.57 & 0.96 & 1.00 & 1 & 0.74 & 0.99 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSs-parsim.png}\\
WLSs-lasso & 0.48 & 0.62 & 0.72 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.30 & 0.42 & 1.00 & 1.00 & 1 & 0.68 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSv-subset.png}\\
WLSv-parsim & 0.49 & 0.53 & 0.99 & 1.00 & 1 & 0.47 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSv-parsim.png}\\
WLSv-lasso & 0.35 & 0.70 & 0.85 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinT-parsim.png}\\
MinT-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 0.87 & 0.85 & 1.00 & 1.00 & 1 & 0.85 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinTs-parsim.png}\\
MinTs-lasso & 0.86 & 0.84 & 1.00 & 1.00 & 1 & 0.85 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.94 & 0.79 & 0.93 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p1_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
Xiaoqian Wang and Rob J Hyndman are members of the Australian Research
...
\midrule
OLS-subset & 0.75 & 0.45 & 0.44 & 0.82 & 0.79 & 0.83 & 0.80 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_OLS-subset.png}\\
OLS-parsim & 0.47 & 0.70 & 0.69 & 0.86 & 0.92 & 0.90 & 0.89 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_OLS-parsim.png}\\
OLS-lasso & 0.38 & 0.01 & 0.01 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.08 & 0.42 & 0.41 & 0.87 & 0.85 & 0.84 & 0.89 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSs-subset.png}\\
WLSs-parsim & 0.06 & 0.55 & 0.50 & 0.66 & 0.87 & 0.69 & 0.88 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSs-parsim.png}\\
WLSs-lasso & 0.35 & 0.03 & 0.03 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.31 & 0.67 & 0.65 & 0.88 & 0.90 & 0.91 & 0.90 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSv-subset.png}\\
WLSv-parsim & 0.34 & 0.63 & 0.60 & 0.80 & 0.89 & 0.84 & 0.87 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSv-parsim.png}\\
WLSv-lasso & 0.45 & 0.35 & 0.36 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 0.69 & 0.78 & 0.80 & 0.91 & 0.91 & 0.91 & 0.91 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinT-parsim.png}\\
MinT-lasso & 0.75 & 0.89 & 0.86 & 0.97 & 0.97 & 0.97 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 0.67 & 0.74 & 0.76 & 0.90 & 0.89 & 0.88 & 0.91 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinTs-parsim.png}\\
MinTs-lasso & 0.77 & 0.72 & 0.73 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.95 & 0.64 & 0.64 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s3_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.52 & 0.79 & 0.57 & 0.79 & 1 & 0.91 & 0.85 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_OLS-subset.png}\\
OLS-parsim & 0.80 & 0.90 & 0.81 & 0.80 & 1 & 0.85 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_OLS-parsim.png}\\
OLS-lasso & 0.90 & 1.00 & 0.68 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.85 & 0.91 & 0.86 & 0.90 & 1 & 0.97 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSs-subset.png}\\
WLSs-parsim & 0.92 & 0.95 & 0.67 & 0.92 & 1 & 0.92 & 0.95 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSs-parsim.png}\\
WLSs-lasso & 0.72 & 1.00 & 0.72 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.50 & 0.62 & 0.42 & 0.19 & 1 & 0.81 & 0.87 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSv-subset.png}\\
WLSv-parsim & 0.59 & 0.55 & 0.49 & 0.17 & 1 & 0.76 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSv-parsim.png}\\
WLSv-lasso & 0.40 & 1.00 & 0.41 & 0.77 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 0.66 & 0.90 & 0.61 & 0.72 & 1 & 0.91 & 0.93 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinT-parsim.png}\\
MinT-lasso & 0.80 & 0.96 & 0.84 & 0.72 & 1 & 0.98 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 0.57 & 0.88 & 0.52 & 0.67 & 1 & 0.89 & 0.92 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinTs-parsim.png}\\
MinTs-lasso & 0.68 & 1.00 & 0.66 & 0.74 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.82 & 0.63 & 0.69 & 1.00 & 1 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/s1_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.35 & 0.38 & 0.96 & 0.97 & 0.99 & 0.73 & 0.98 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_OLS-subset.png}\\
OLS-parsim & 0.59 & 0.62 & 0.93 & 0.92 & 1.00 & 0.61 & 0.96 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_OLS-parsim.png}\\
OLS-lasso & 0.65 & 0.41 & 0.50 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.35 & 0.43 & 0.99 & 1.00 & 1.00 & 0.73 & 0.99 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSs-subset.png}\\
WLSs-parsim & 0.56 & 0.54 & 0.97 & 0.98 & 1.00 & 0.70 & 0.98 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSs-parsim.png}\\
WLSs-lasso & 0.62 & 0.66 & 0.82 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.34 & 0.44 & 1.00 & 1.00 & 1.00 & 0.68 & 0.99 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSv-subset.png}\\
WLSv-parsim & 0.55 & 0.52 & 0.98 & 1.00 & 1.00 & 0.62 & 0.97 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSv-parsim.png}\\
WLSv-lasso & 0.63 & 0.76 & 0.92 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinT-parsim.png}\\
MinT-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 0.95 & 0.93 & 1.00 & 1.00 & 1.00 & 0.93 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinTs-parsim.png}\\
MinTs-lasso & 0.96 & 0.94 & 1.00 & 1.00 & 1.00 & 0.96 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.93 & 0.73 & 0.98 & 1.00 & 0.99 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p3_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.37 & 0.49 & 0.95 & 0.94 & 0.99 & 0.73 & 0.95 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_OLS-subset.png}\\
OLS-parsim & 0.55 & 0.74 & 0.92 & 0.88 & 0.98 & 0.67 & 0.92 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_OLS-parsim.png}\\
OLS-lasso & 0.70 & 0.57 & 0.61 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.37 & 0.54 & 0.99 & 0.98 & 1.00 & 0.77 & 0.98 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSs-subset.png}\\
WLSs-parsim & 0.60 & 0.60 & 0.98 & 0.96 & 1.00 & 0.71 & 0.96 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSs-parsim.png}\\
WLSs-lasso & 0.74 & 0.80 & 0.90 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.35 & 0.55 & 1.00 & 0.99 & 1.00 & 0.78 & 0.95 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSv-subset.png}\\
WLSv-parsim & 0.60 & 0.58 & 0.99 & 1.00 & 1.00 & 0.86 & 0.84 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSv-parsim.png}\\
WLSv-lasso & 0.76 & 0.82 & 0.95 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinT-parsim.png}\\
MinT-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 1.00 & 0.99 & 1.00 & 1.00 & 1.00 & 0.99 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinTs-parsim.png}\\
MinTs-lasso & 1.00 & 0.99 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.92 & 0.80 & 0.98 & 1.00 & 0.97 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p5_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.37 & 0.53 & 0.98 & 0.92 & 0.98 & 0.81 & 0.90 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_OLS-subset.png}\\
OLS-parsim & 0.58 & 0.78 & 0.96 & 0.88 & 0.97 & 0.78 & 0.89 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_OLS-parsim.png}\\
OLS-lasso & 0.73 & 0.59 & 0.64 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.35 & 0.57 & 1.00 & 0.99 & 1.00 & 0.86 & 0.92 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSs-subset.png}\\
WLSs-parsim & 0.62 & 0.61 & 0.99 & 0.96 & 1.00 & 0.78 & 0.88 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSs-parsim.png}\\
WLSs-lasso & 0.79 & 0.81 & 0.93 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.35 & 0.58 & 1.00 & 1.00 & 1.00 & 0.89 & 0.85 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSv-subset.png}\\
WLSv-parsim & 0.61 & 0.53 & 1.00 & 1.00 & 0.99 & 0.96 & 0.73 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSv-parsim.png}\\
WLSv-lasso & 0.83 & 0.89 & 0.98 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinT-parsim.png}\\
MinT-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinTs-parsim.png}\\
MinTs-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.89 & 0.76 & 0.99 & 0.99 & 0.91 & 1.00 & 0.99 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p7_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
...
\midrule
OLS-subset & 0.33 & 0.52 & 0.96 & 0.95 & 0.98 & 0.96 & 0.78 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_OLS-subset.png}\\
OLS-parsim & 0.54 & 0.77 & 0.93 & 0.89 & 0.97 & 0.83 & 0.85 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_OLS-parsim.png}\\
OLS-lasso & 0.69 & 0.53 & 0.60 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_OLS-lasso.png}\\
\midrule\\
WLSs-subset & 0.29 & 0.60 & 1.00 & 1.00 & 1.00 & 0.98 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSs-subset.png}\\
WLSs-parsim & 0.63 & 0.67 & 0.99 & 0.98 & 1.00 & 0.93 & 0.86 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSs-parsim.png}\\
WLSs-lasso & 0.69 & 0.76 & 0.91 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSs-lasso.png}\\
\midrule\\
WLSv-subset & 0.32 & 0.55 & 1.00 & 1.00 & 1.00 & 0.99 & 0.76 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSv-subset.png}\\
WLSv-parsim & 0.58 & 0.56 & 1.00 & 1.00 & 0.98 & 1.00 & 0.75 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSv-parsim.png}\\
WLSv-lasso & 0.77 & 0.84 & 0.99 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_WLSv-lasso.png}\\
\midrule\\
MinT-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinT-subset.png}\\
MinT-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinT-parsim.png}\\
MinT-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinT-lasso.png}\\
\midrule\\
MinTs-subset & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinTs-subset.png}\\
MinTs-parsim & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinTs-parsim.png}\\
MinTs-lasso & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_MinTs-lasso.png}\\
\midrule\\
Elasso & 0.73 & 0.65 & 0.98 & 0.98 & 0.86 & 1.00 & 0.99 & \includegraphics[width=0.47in, height=0.1in]{/home/hyndman/git/Research/hfs/paper/_figs/corr_p9_Elasso.png}\\
\bottomrule
\end{tabular}
\endgroup{}
