...
\setstretch{1.5}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, enhanced, frame hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
...
subsequently into distinct items \citep{Zhang2023-op, Hollyman2021-un}.
An illustrative data example for hierarchical forecasting of electricity
load involves the electricity consumption measured by a lot of smart
meters with a comprehensive geographic hierarchy \citep{Taieb2021-tc}.
For additional interesting application examples, please refer to
